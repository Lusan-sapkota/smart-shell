...
Smart-Shell is licensed under the Apache License 2.0.
...
For the complete license text, see the [LICENSE file](https://github.com/Lusan-sapkota/smart-shell/blob/main/LICENSE) in the repository.
